            ...
            case I_MOVE: {
                ...
                for(Temp_tempList p = spilled; p; p = p->tail){
                    ...
                    if(indst!=NULL){    
                        ...
                        Temp_tempList s = Temp_TempList(replacement, Temp_TempList(F_FP(), NULL));
                        ...
                        Temp_tempList d = Temp_TempList(replacement, NULL);
                        Temp_tempList s = Temp_TempList(F_FP(), NULL);
